...
export default function Footer() {
  const [s, setS] = useState({ whatsapp: '', instagram_occasions: '', instagram_boxes: '' })
  ...
  return (
    <footer className="py-16 px-4 border-t border-brand-cream/10">
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-5 flex justify-center">
          <div className="w-20 h-20 relative">
            <Image src="/logo-flower-white.png" alt="Cozy" fill className="object-contain" />
          </div>
        </div>

        <p className="text-[#F5F0EB]/80 mb-10 text-sm">شوكولاتة مصنوعة بحب في الجبيل</p>
        ...
        <p className="text-[#F5F0EB]/40 text-xs mt-12">&copy; 2025 Cozy Chocolate. جميع الحقوق محفوظة</p>
      </div>
    </footer>
  )
}
